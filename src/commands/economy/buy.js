        ...
        try {
            ...
            if (!item) {
                const embed = new Discord.EmbedBuilder()
                    ...
                    .setDescription("O item que você deseja comprar não foi encontrado na loja.");
            ...
            if (!user || user.coins < item.price) {
                const embed = new Discord.EmbedBuilder()
                    ...
                    .setDescription("Você não possui moedas suficientes para comprar este item.");
            ...
            try {
                ...
                console.log("Erro ao adicionar cargo ao usuário:", error);
                const embed = new Discord.EmbedBuilder()
                    .setColor("Red")
            ...
            if (addedByUser) {
                ...
                console.log(`Usuário com ID ${addedByUserId} não encontrado na carteira.`);
            }
            ...
            const embed = new Discord.EmbedBuilder()
                ...
                .setDescription(`Você comprou o item "${item.name}" da loja com sucesso.`);
            ...
            if (logchannel) {
                const logembed = new Discord.EmbedBuilder()
                    .setColor(apptheme.maincolor)
                    .setTitle("Compra Realizada!")
                    .setDescription(`${interaction.user} comprou o item "${item.name}"! @${addedByUserId} ganhou ${ecoCfg.coinsymb}:${rewardAmount} de comissão.`);
                logchannel.send({ embeds: [logembed] });
            }

        } catch (e) {
            console.log(themes.error("Erro ") + `ao comprar o item da loja devido à: ${e}`)
