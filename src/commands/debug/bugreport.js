...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    if (!devUser) {
      ...
      console.log(
        themes.error("Erro ") + `ID do dono/desenvolvedor não configurado.`
      );
    ...
    try {
      ...
      console.log(
        themes.error("Erro ") +
          `ao enviar o bug report para a DM do desenvolvedor devido à:\n ${e}`
      );
      logger.error(
        `Erro ao enviar o bug report para a DM do desenvolvedor devido à: ${e}`
      );
    }
  },
};
